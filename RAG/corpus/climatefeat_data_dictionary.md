...
Model performance from March 15, 2026 notebooks: ClimateFEAT Transformer validation RMSE 139 MWh / 12.0% pop-weighted, test RMSE 172 MWh / 14.8% pop-weighted. LightGBM v4 validation RMSE 141 MWh / 12.0% pop-weighted, test RMSE 199 MWh / 17.4% pop-weighted. See `climatefeat_model_performance.md` for full error analysis.
